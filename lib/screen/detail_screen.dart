...
class _DetailScreenState extends State<DetailScreen> {
  //nilai ini "HIDUP" selama widget state ini ada, setiap kali diubah oleh setState, flutter akan melakukan rebuild, supaya tampilan ikut terupgrade

  int _quantity = 1;

  // kenapa ga pek if condition gara gara bebas mau nambahin sampe berapa aja

  void _increment() => setState(() => _quantity++);

  //ga pake if condition biar ga bisa dikurangin lebih dari 1
  void _decrement() {
    if (_quantity > 1) {
      setState(() => _quantity--);
    }
